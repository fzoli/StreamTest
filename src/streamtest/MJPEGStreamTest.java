...
class MJPEGServer {
    ...
    public MJPEGServer() throws IOException {
...
class MJPEGClient {
    ...
    public MJPEGClient() throws UnknownHostException, IOException {
...
public class MJPEGStreamTest {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length > 0) {
            if (args[0].equals("server")) new MJPEGServer();
            else new MJPEGClient();
        }
        else {
//            new MJPEGServer();
            new MJPEGClient();
